...
<body class="bg-[#F6FCFF]">
    ...
    <main class="py-36 px-20">
        <form action="{{ route('update.artikel', ['id' => $article->id]) }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            @method('PATCH')
        <h1 class="text-5xl tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#0398EC] to-[#046CB4]"
            style="font-family: gilroy-reguler">Edit Article</h1>
            <div class="py-20 flex flex-col space-y-6" style="font-family: gilroy-reguler">
                <div>
                    ...
                    <input onKeyPress="edValueKeyPress()"
                     type="text" name="title" id="title" value="title" class="w-full outline-none border-none rounded-lg bg-blue-50 mt-2 ml-8"
                     placeholder="Title">
                </div>
                <div>
                    <label for="description" class="block text-lg font-semibold ">Description</label>
                    <textarea  name = "description" value="description" id="message" rows="4" class="w-full outline-none border-none rounded-lg bg-blue-50 mt-2 ml-8 p-4"
                        placeholder="Write description here">{{$article->description}}</textarea>
                </div>
                <div>
                    ...
                    <div class="flex justify-center items-center w-64 mt-2 ml-8">
                        <label class="cursor-pointer" for="file">
                            ...
                            <input name="media" id="file" type="file" class="hidden">
                        </label>
            ...
            <div class="overflow-auto py-16">
                ...
                <div class="inline-flex gap-6 items-center mt-2 ml-8">
                    <label class="relative cursor-pointer">
                        <input type="checkbox" class="peer sr-only" name="category[]" value="Architecture" {{ in_array('Architecture', $article->category) ? 'checked' : '' }}/>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="checkbox" class="peer sr-only" name="category[]" value="Business" {{ in_array('Business', $article->category) ? 'checked' : '' }}/>
                        <div class="overflow-hidden rounded-lg px-5 py-[10px] border-2 peer-checked:bg-gradient-to-r peer-checked:from-[#0398EC] peer-checked:to-[#046CB4] peer-checked:hover:bg-gradient-to-r peer-checked:hover:from-[#046CB4] peer-checked:hover:to-[#0398EC] shadow-md ring ring-transparent text-gray-500 peer-checked:text-gray-50 transition-all active:scale-95 peer-checked:grayscale-0">
                          <p class="">Business</p>
                        </div>
                    </label>
                    <label class="relative cursor-pointer">
                        <input type="checkbox" class="peer sr-only" name="category[]" value="Development" {{ in_array('Development', $article->category) ? 'checked' : '' }}/>
                        <div class="overflow-hidden rounded-lg px-5 py-[10px] border-2 peer-checked:bg-gradient-to-r peer-checked:from-[#0398EC] peer-checked:to-[#046CB4] peer-checked:hover:bg-gradient-to-r peer-checked:hover:from-[#046CB4] peer-checked:hover:to-[#0398EC] shadow-md ring ring-transparent text-gray-500 peer-checked:text-gray-50 transition-all active:scale-95 peer-checked:grayscale-0">
                          <p class="">Development</p>
                        </div>
                    </label>
                    <label class="relative cursor-pointer">
                        <input type="checkbox" class="peer sr-only" name="category[]" value="Education" {{ in_array('Education', $article->category) ? 'checked' : '' }}/>
                        <div class="overflow-hidden rounded-lg px-5 py-[10px] border-2 peer-checked:bg-gradient-to-r peer-checked:from-[#0398EC] peer-checked:to-[#046CB4] peer-checked:hover:bg-gradient-to-r peer-checked:hover:from-[#046CB4] peer-checked:hover:to-[#0398EC] shadow-md ring ring-transparent text-gray-500 peer-checked:text-gray-50 transition-all active:scale-95 peer-checked:grayscale-0">
                          <p class="">Education</p>
                        </div>
                    </label>
                    <label class="relative cursor-pointer">
                        <input type="checkbox" class="peer sr-only" name="category[]" value="Financial" {{ in_array('Financial', $article->category) ? 'checked' : '' }}/>
                        <div class="overflow-hidden rounded-lg px-5 py-[10px] border-2 peer-checked:bg-gradient-to-r peer-checked:from-[#0398EC] peer-checked:to-[#046CB4] peer-checked:hover:bg-gradient-to-r peer-checked:hover:from-[#046CB4] peer-checked:hover:to-[#0398EC] shadow-md ring ring-transparent text-gray-500 peer-checked:text-gray-50 transition-all active:scale-95 peer-checked:grayscale-0">
                          <p class="">Financial</p>
                        </div>
                    </label>
                    <label class="relative cursor-pointer flex">
                        <input type="checkbox" class="peer sr-only" name="category[]" id="myCheck" onclick="myFunction()" value="" {{ in_array('Other', $article->category) ? 'checked' : '' }} />
                        <div class="overflow-hidden rounded-lg px-5 py-[10px] border-2 peer-checked:bg-gradient-to-r peer-checked:from-[#0398EC] peer-checked:to-[#046CB4] peer-checked:hover:bg-gradient-to-r peer-checked:hover:from-[#046CB4] peer-checked:hover:to-[#0398EC] shadow-md ring ring-transparent text-gray-500 peer-checked:text-gray-50 transition-all active:scale-95 peer-checked:grayscale-0">
                          <p class="">Other</p>
                        </div>
            ...
            <div class="inline-flex items-center">
                ...
                <button type="submit" class="px-14 py-3 bg-[#283C85] rounded-xl text-white shadow-lg">Save Change</button>
            </div>
        </form>
    </main>
    @livewireStyles
