...
<body class="bg-[#F6FCFF]">
    ...
    <main>
        <!-- Services -->
        <div class="md:mb-40 mb-10 md:px-20 px-4 py-20">
            <h1 class="text-primary md:text-4xl text-3xl font-semibold md:mt-16 mt-10 leading-tight subpixel-antialiased tracking-wider text-center"
                style="font-family: gilroy-bold;">SERVICES</h1>
            <p class="text-gray-500 text-center mt-4 font-semibold leading-tight subpixel-antialiased tracking-wider"
                style="font-family: gilroy-light;">We can help your business grow with the various services we have</p>

            <div class="flex flex-wrap gap-16 py-10 mt-10 justify-center items-center mx-5
                        xl:px-32 xl:gap-24" 
                ...
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        ...
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Adtech & Marketing</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/adtech&marketing' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 21.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Software Development</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ url('/software-development') }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/outsourcing 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Outsource Talent Service</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/outsource-talent-service' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 23.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Design & Architecture</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/design&architecture' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 24.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Media & Entertainment</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/media&entertainment' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 27.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Retail Market</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="#" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/online-course 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Education</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/education' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/budget 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Financial</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/financial' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/clarity_truck-line.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-lg mt-6 text-center text-[#00569E]">Logistic</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam</p>
                        <a href="{{ '/logistic' }}" class="text-sm font-semibold text-center text-[#3146FE] mt-auto">Read more</a>
                    </div>
                </div>
            </div>
        </div>
