...
<body class="bg-[#F6FCFF]">
    ...
    <main>
        <div class="mb-10 md:px-2 px-4 py-20">
            <h1 class="text-primary md:text-4xl text-3xl font-semibold md:mt-16 mt-10 leading-tight subpixel-antialiased tracking-wider text-center uppercase" style="font-family: gilroy-bold;">Design & Architecture</h1>
            <p class="text-gray-500 text-center mt-4 max-w-5xl mx-auto font-semibold leading-tight subpixel-antialiased tracking-wider" style="font-family: gilroy-light;">we believe that architecture & design can enhance the quality of life by delivering one stop solution for sustainable built environment. We devour our ideas comprehensive by through design thinking</p>
            <div class="flex flex-wrap gap-10 py-10 mt-10 justify-center items-center mx-6
                ...
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        ...
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Empathise</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Conduct research to develop an underestanding of our client's</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/software-development (1) 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Define</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Combine all researcher & observe our client's problems</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/outsourcing 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Ideate</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Generate creative ideas</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 23.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Prototype</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Build the representation of design throgh model & visualization</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 24.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Test</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Return to our client's for feedback</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-72 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/image 27.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">Service</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">Architectural design, interior design, landscape design, grapichs and branding design</p>
                    </div>
                </div>
                <div class="group">
                    <div class="card p-6 bg-white flex flex-col items-center justify-center w-60 h-80 shadow-md mx-auto rounded-lg group-hover:-translate-y-1 group-hover:scale-110 transition ease-in-out delay-150 duration-300 group-hover:shadow-md">
                        <img src="{{ asset('images/new/budget 1.svg') }}" alt="" class="w-16">
                        <h1 class="font-semibold text-base mt-6 text-center text-[#00569E]">AR</h1>
                        <p class="text-sm text-center mt-4 text-gray-500 tracking-wide subpixel-antialiased leading-relaxed">We are experience in handling some various scales and typologiest of buliding, such as café, restaurant, office, houses, and mas</p>
                    </div>
                </div>
            </div>
        </div>
