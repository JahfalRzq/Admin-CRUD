...
<head>
    ...
    <title>Organizational & Structural</title>
...
<body class="bg-[#F6FCFF] ">
    ...
    <main class="min-w-full min-h-screen">
        <div class="flex flex-col justify-center md:px-64 px-6 gap-10 items-center py-[150px]">
            <div class="text-primary md:text-4xl text-3xl leading-tight subpixel-antialiased tracking-wider text-center" style="font-family: gilroy-bold;">
                <p class="font-bold text-[32px] tracking-tight">PT POWERKERTO WAHYU KEPRABON</p><br>
                <p class="font-semibold text-xxl text-[48px] -mt-6">Bagan Struktur Organisasi</p><br>
                <p class="font-bold text-[32px] italic tracking-tight -mt-6">ORGANIZATIONAL STRUCTURE CHART</p>
            </div>
            <img src="{{ asset('images/02 Logo Powerkerto SECONDARY.png') }}" alt="" class="w-[300px]">
                <div class="mt-28">
