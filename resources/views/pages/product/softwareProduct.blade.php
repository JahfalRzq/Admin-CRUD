...
<head>
    ...
    <title>{{$products_software->name}}</title>
...
<body>
    ...
    <div class="">
        ...
        <img src="{{ asset('images/Rectangle 9109.png') }}" alt="" class="absolute -mt-6 -z-50 object-cover bg-no-repeat h-[1100px]" style="background-size: 100vmax; filter: brightness(.3);">
    </div>
    ...
    <div class="max-w-full md:py-16 py-10 md:min-h-[140vh] min-h-screen" style="font-family: gilroy-medium;">
            <img src="../{{$products_software->logo}}" alt="" class="mx-auto w-full mt-20 w-32 h-[60px]">
            <p class="text-gray-200 text-center mt-4 font-medium text-2xl tracking-wider">{{$products_software->tagline}}
            </p>
            ...
            <div class="grid grid-cols-2 mt-10 mx-20 xl:mt-24 xl:mx-[90px] xl:space-x-10">
                <div class="col-span-6 w-80 text-justify mx-auto md:w-[650px] md:text-gray-100 lg:w-[800px] lg:text-gray-100 xl:col-auto xl:w-[650px] text-gray-100 xl:text-gray-100 font-normal text-xl">
                    {{$products_software->caption}}
                    <br><br><br>
                    <span class="md:text-gray-700 lg:text-gray-100">
                    {{$products_software->caption}}</span>

                    <div class="mt-96 absolute md:mt-[350px] lg:mt-[440px] xl:mt-10">
                        <a href="{{$products_software->url}}" target="_blank">
                ...
                <div class="col-span-6 mt-10 xl:col-auto xl:mt-0 bg-red-500">
                    <img src="../{{$products_software->product_image }}" class="h-[385px]" alt="">
                </div>
                <div class="absolute left-0 mt-[625px] w-full  h-full lg:mt-[550px] xl:h-full -z-30" style="">
                    <svg class="-mx-10 w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,192L48,176C96,160,192,128,288,117.3C384,107,480,117,576,144C672,171,768,213,864,240C960,267,1056,277,1152,240C1248,203,1344,117,1392,74.7L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
                </div>


            </div>

            <div class="grid grid-cols-2 mt-96 mb-10 md:flex md:mt-40 lg:mt-36 xl:mt-64">
