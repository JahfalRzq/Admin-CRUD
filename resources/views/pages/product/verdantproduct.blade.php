...
<head>
    ...
    <style>
        ...
        body {
            background: url("{{ asset('images/verdantbg.png') }}");
...
<body>
    ...
    <div class="md:mt-6 md:mx-20 z-50 flex justify-center">
        <nav x-data="{ open: false }" class="fixed flex flex-col px-4 mx-auto md:w-[730px] lg:w-[1000px] xl:w-[1350px] md:items-center md:justify-between md:flex-row md:px-6 lg:px-8 w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 md:rounded-full shadow-md z-40">
    ...
    <div class="max-w-full md:py-16 py-10 md:min-h-[140vh] min-h-screen" style="font-family: gilroy-medium;">
            <img src="{{ asset('images/verdant.png') }}" alt="" class="mx-auto mt-20">
            <p class="text-gray-200 text-center mt-4 font-medium text-2xl tracking-wider">
                Verdant Natural is a herbal product from Indonesia that is inspired by nature and tradition.
            </p>
            ...
            <div class="grid grid-cols-2 mt-10 mx-20 xl:mt-24 xl:mx-[90px] xl:space-x-10">
                <div class="col-span-6 w-80 text-justify mx-auto md:w-[650px] md:text-gray-100 lg:w-[800px] lg:text-gray-100 xl:col-auto xl:w-[650px] text-gray-700 xl:text-gray-100 font-normal text-xl">
                    ...
                    We have a strong ecosystem and products that allow us to promote and
                    sell it to the end customer by various way (online and offline method). One
                    of our newest method is 'affiliate marketing'. The method that makes
                    anyone and anywhere gain their profit and success.
                    <br><br><br>
                    <span class="md:text-gray-700 lg:text-gray-100">Relying on the finest natural resources in Indonesia, they formulate plant bliss combined with premium ingredients and state-of-the-art technology, 
                    to deliver visible and long-lasting results.</span>

                    <div class="mt-56 absolute md:mt-[350px] lg:mt-[400px] xl:mt-10">
                        <a href="https://verdantnatural.com/" target="_blank">
                ...
                <div class="col-span-6 mt-10 mx-auto xl:col-auto xl:mt-0">
                    <img src="{{ asset('images/product-03.png') }}" alt="" class="w-[600px] lg:w-[700px]">
                </div>
            </div>

            <div class="grid grid-cols-2 mt-40 mb-10 md:mt-40 md:flex lg:mt-36 xl:mt-72">
                <div class="col-span-6 mx-auto xl:col-auto">
                    ...
                    <ul class="mt-5 list-inside font-semibold text-gray-700" style="list-style-type:disc">
                        <li class="mt-2">Website</li>
                        <li class="mt-2">Affiliate Program</li>
