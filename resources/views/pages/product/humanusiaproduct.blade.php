...
<head>
    ...
    <style>
        ...
        body {
            background: url("{{ asset('images/hrisbg.png') }}");
...
<body>
    ...
    <div class="max-w-full md:py-16 py-10 md:min-h-[140vh] min-h-screen" style="font-family: gilroy-medium;">
            <img src="{{ asset('images/humanusia-logo.png') }}" alt="" class="mx-auto mt-20">
            ...
            <div class="grid grid-cols-2 mt-10 mx-20 xl:mt-24 xl:mx-[90px] xl:space-x-10">
                <div class="col-span-6 w-80 text-justify mx-auto md:w-[650px] md:text-gray-100 lg:w-[800px] lg:text-gray-100 xl:col-auto xl:w-[650px] text-gray-700 xl:text-gray-100 font-normal text-xl">
                    Humanusia or Human Resources Information System (HRIS) is a 'must have' software in any business/organisation. Our HRIS software is 'end to end' HRIS application that simplify every part of human resources management, from employee management, document management, time management, recruitment and any others part of HR management system.
                    <div class="mt-[400px] absolute md:mt-[700px] lg:mt-[780px] xl:mt-10">
                        <a href="https://humanusia.id/" target="_blank">
                ...
                <div class="col-span-6 mt-10 mx-auto xl:col-auto xl:mt-0">
                    <img src="{{ asset('images/humanusia.png') }}" alt="" class="w-[600px] lg:w-[700px]">
                </div>
            </div>

            <div class="grid grid-cols-2 mt-40 mb-10 md:mt-40 md:flex lg:mt-32 ">
                ...
                <div class="col-span-6 mx-auto mt-10 md:mt-0 xl:col-auto xl:mt-0">
                    ...
                    <ul class="mt-5 list-inside font-semibold text-gray-700" style="list-style-type:disc">
                        <li>Figma</li>
                        <li class="mt-2">HTML 5</li>
                        <li class="mt-2">CSS 3</li>
