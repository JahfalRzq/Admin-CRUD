...
<head>
    ...
    <style>
        ...
        body {
            background: url("{{ asset('images/crmbg.png') }}");
...
<body>
    ...
    <div class="max-w-full md:py-16 py-10 md:min-h-[140vh] min-h-screen" style="font-family: gilroy-medium;">
            <img src="{{ asset('images/crm.png') }}" alt="" class="mx-auto mt-20">
            <p class="text-gray-200 text-center mt-4 font-medium text-2xl tracking-wider">
                Platform CRM untuk UMKM Terlengkap
            </p>
            ...
            <div class="grid grid-cols-2 mt-10 mx-20 xl:mt-24 xl:mx-[90px] xl:space-x-10">
                <div class="col-span-6 w-80 text-justify mx-auto md:w-[650px] md:text-gray-100 lg:w-[800px] lg:text-gray-100 xl:col-auto xl:w-[650px] text-gray-700 xl:text-gray-100 font-normal text-xl">
                    Customer Relationship Management (CRM) menjadi aktivitas yang sangat penting bagi pebisnis UMKM. Kini telah hadir platform CRM yang terbukti bisa meningkatkan upselling, cross-selling dan repeat order.
                    <br><br><br>
                    <span class="md:text-gray-700 lg:text-gray-100">Croya CRM dibangun dalam sebuah ekosistem besar yang lengkap. Pengguna Croya bisa mengintegrasokan layanannya dengan produk/solusi lain yang, sehingga akan menjadi solusi 360 derajat bagi UMKM  yang bergerak di bidang e-commerce dan penjualan online.</span>
                ...
                <div class="col-span-6 mt-10 mx-auto xl:col-auto xl:mt-0">
                    <img src="{{ asset('images/image 48.png') }}" alt="" class="w-[600px] lg:w-[700px]">
                </div>
            </div>

            <div class="grid grid-cols-2 mt-40 mb-10 md:mt-40 md:flex lg:mt-36 xl:mt-56">
