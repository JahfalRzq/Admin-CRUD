    ...
    <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
        <div class="container mx-auto px-4 py-2 md:py-8">
            <div class="bg-transparent rounded-lg overflow-hidden">
                ...
                <div class="text-black font-bold text-lg mr-20 mt-7">Events Attending</div>
                <div class="grid grid-cols-2 justify-between w-full items-center ml-2 mt-5">
        ...
        function app() {
            return {
                ...
                events: [{
                    ...
                    {
                        event_date: new Date(2022, 10, 11),
